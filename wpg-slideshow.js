...
var WPGSlideshow = /** @class */ (function () {
            ...
            this.slideshowsNodeList.forEach(function (slideshow) {
                ...
                containerNodeList.forEach(function (container) {
                    ...
                    items.forEach(function (item) {
                        itemID++;
                        item.id = "wpg-slide-" + ssID_1 + "-" + itemID; // First id has value of 1
    ...
    WPGSlideshow.prototype.changeSlides = function (btn, changeValue) {
        ...
        // Hide current slide
        var currentSlide = document.getElementById("wpg-slide-" + id + "-" + slideshow.index);
        ...
        var newSlide = document.getElementById("wpg-slide-" + id + "-" + slideshow.index);
